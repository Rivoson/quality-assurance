...
class Translator {
  britishIdioms(string) {
    ...
    for (var i = 0; i < idioms.length; i++) {
      ...
      for (var j = 0; j < array1.length; j++) {
        ...
        if (
          !letters.test(translation[index - 1]) &&
          !letters.test(translation[index + idioms[i].length])
        ) {
          ...
          translation =
            ...
            translation
              ...
              .replace(
                regex3,
                highlight1 + americanOnly[idioms[i]] + highlight2
              );
        }
      }
    }
  ...
  britishSpelling(string) {
    ...
    for (var i = 0; i < spelling.length; i++) {
      ...
      for (var j = 0; j < array1.length; j++) {
        ...
        console.log(array1[j] + " " + letters.test(translation[index - 1]));
        if (
          !letters.test(string[index - 1]) &&
          !letters.test(string[index + spelling[i].length])
        ) {
          translation =
            translation.slice(0, index) +
            translation
              ...
              .replace(
                regex3,
                highlight1 + americanToBritishSpelling[spelling[i]] + highlight2
              );
        }
      }
    }
  ...
  britishTitle(string) {
    ...
    for (var i = 0; i < titles.length; i++) {
      ...
      for (var j = 0; j < array1.length; j++) {
        ...
        if (
          !letters.test(string[index - 1]) &&
          !letters.test(string[index + titles[i].length])
        ) {
          translation =
            translation.slice(0, index) +
            translation
              ...
              .replace(
                regex3,
                highlight1 +
                  titles[i].replace(/^\w/, (c) => c.toUpperCase()) +
                  highlight2
              );
        }
      }
    ...
    if (regex.test(translation)) {
      ...
      for (i = 0; i < found.length; i++) {
        ...
        translation = translation.replace(
          /\d{1,2}:\d\d/,
          '<span class="highlight">' + found[i] + "</span>"
        );
      }
    }
    return translation;
  ...
  americanSpelling(string) {
    ...
    for (var i = 0; i < britishSpelling.length; i++) {
      ...
      for (var j = 0; j < array1.length; j++) {
        ...
        if (
          !letters.test(string[index - 1]) &&
          !letters.test(string[index + britishSpelling[i].length])
        ) {
          console.log("posso tradurre");
          translation =
            translation.slice(0, index) +
            translation
              .slice(index)
              .replace(regex3, highlight1 + americanSpelling[i] + highlight2);
        }
      }
    }
    return translation;
  ...
  americanIdioms(string) {
    ...
    for (var i = 0; i < britishIdioms.length; i++) {
      //american idioms
      let letters = /^[a-zA-Z]$/;
      ...
      for (var j = 0; j < array1.length; j++) {
        ...
        console.log(
          array1[j] +
            ...
            letters.test(string[index - 1]) +
            " " +
            letters.test(string[index + britishIdioms[i].length])
        );
        ...
        if (
          ...
          translation =
            ...
            translation
              .slice(index)
              .replace(regex3, highlight1 + americanIdioms[i] + highlight2);
        }
      }
    }
  ...
  americanTitles(string) {
    ...
    for (var i = 0; i < britishTitles.length; i++) {
      ...
      for (var j = 0; j < array1.length; j++) {
        ...
        if (
          !letters.test(string[index - 1]) &&
          !letters.test(string[index + britishTitles[i].length])
        ) {
          translation =
            translation.slice(0, index) +
            translation
              ...
              .replace(
                regex3,
                highlight1 +
                  americanTitles[i].replace(/^\w/, (c) => c.toUpperCase()) +
                  highlight2
              );
        }
      }
