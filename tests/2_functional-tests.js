  ...
  suite("POST to /api/check", function () {
    ...
    test("Invalid character in puzzle", function (done) {
      chai
        ...
        .send({
          puzzle:
            "..9..5.1.85.4....2N32......1...69.83.9.....6.62.71...9......1945....4.37.4.3..6..",
          coordinate: "E5",
          value: "6",
        })
        .end(function (err, res) {
  ...
  suite("POST to /api/solve", function () {
    ...
    test("Solve a puzzle with invalid characters", function (done) {
      chai
        ...
        .send({
          puzzle:
            "..839.7.575.....964..1.......16.2W846.9.3p2.7..754.....62..5.78.8...3.2...492...1",
        })
        .end(function (err, res) {
          assert.equal(res.status, 200);
          assert.property(res.body, "error");
    ...
    test("Solve a puzzle with incorrect length", function (done) {
      chai
        ...
        .send({
          puzzle:
            "..839.7.575.....964..1.......16.29846.9.312.7..754.....62..5.78.8...3.2...4",
        })
        .end(function (err, res) {
          assert.equal(res.status, 200);
          assert.property(res.body, "error");
    ...
    test("Solve a puzzle that cannot be solved", function (done) {
      chai
        ...
        .send({
          puzzle:
            "1.5..2.84..63.12.7.2..5.....9..1....8.2.3674.3.7.2..9.47...8..1..16....923914.67.",
        })
        .end(function (err, res) {
          assert.equal(res.status, 200);
          assert.property(res.body, "error");
