  ...
  suite("POST to api/translate/", function () {
    test("Valid text and valid locale field", function (done) {
      chai
        ...
        .post("/api/translate")
        .send({
          text: "Mr. Smith carbonized blood sausage at 2:30 and 3:40",
        ...
        .end(function (err, res) {
          ...
          assert.equal(
            ...
            '<span class="highlight">Mr</span> Smith <span class="highlight">carbonised</span> <span class="highlight">black pudding</span> at <span class="highlight">2.30</span> and <span class="highlight">3.40</span>'
          );
          done();
        });
    });
