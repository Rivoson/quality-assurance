...
suite("UnitTests", () => {
  ...
  suite("Function sudokuSolver.validate(puzzleString)", function () {
    ...
    test("Invalid characters in string", function (done) {
      let puzzleString =
        "1.5..2.84..6A.12.7.2..5.....9..1....8.2.3674.3.7.2..9.47...8..1..16....926914.37.";
  ...
  suite(
    "Function sudokuSolver.checkRowPlacement(puzzleString, row, column, value)",
    function () {
  ...
  suite(
    "Function sudokuSolver.checkColPlacement(puzzleString, row, column, value)",
    function () {
  ...
  suite(
    "Function sudokuSolver.checkRegionPlacement(puzzleString, row, column, value)",
    function () {
  ...
  suite("Function sudokuSolver.solve(puzzleString)", function () {
    ...
    test("An invalid string fails the solver", function (done) {
      let puzzleString =
        "57.892.....5....3.4.2..4..1.5689..472...6.....1.7.5.63873.1.2.8.6..47.1..2.9.387.";
